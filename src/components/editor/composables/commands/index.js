...
import { ChangeNodeUserProp } from './change-node-user-prop';
...
EditCommandsRegistry.current.registerCommand(
  ChangeNodePosition.NAME,
  ChangeNodePosition
);
EditCommandsRegistry.current.registerCommand(
  ChangeNodeName.NAME,
...
EditCommandsRegistry.current.registerCommand(
  ChangeNodeColor.NAME,
  ChangeNodeColor
);
EditCommandsRegistry.current.registerCommand(
  ChangeNodeUserProp.NAME,
  ChangeNodeUserProp
);
EditCommandsRegistry.current.registerCommand(
  ChangePortName.NAME,
...
EditCommandsRegistry.current.registerCommand(
  DeleteConnectionsByPort.NAME,
  DeleteConnectionsByPort
);
EditCommandsRegistry.current.registerCommand(
  DeleteConnectionById.NAME,
